    ...
    <section className={styles.hero}>
      ...
      <div className={styles.hero__content}>
        <div className={styles.hero__top}>
          ...
          {/* Cerrada la campaña, el titular pierde los interrogantes: ya no
              plantea un reto abierto, afirma la pieza. */}
          <h1 className={styles.hero__title}>
            <span className={styles.hero__line}>LA PAELLA</span>{" "}
            <span className={styles.hero__line}>IMPOSIBLE</span>
          </h1>
        </div>

        <div className={styles.hero__bottom}>
          <p className={styles.hero__paragraph}>
            Celebramos el 10 aniversario del PaellaEmoji
            <br />
            <strong>convirtiéndolo en un símbolo de unión.</strong>
          </p>
